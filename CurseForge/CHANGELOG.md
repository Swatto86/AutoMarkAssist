...
### Database
- **TBC 5-Man Dungeon Database Rebuilt:** All sixteen Burning Crusade dungeon rosters were rebuilt from scratch against Wowhead TBC Classic data and current TBC Anniversary dungeon guides. The old lists contained many mobs that do not exist in their dungeon (e.g. "Hellfire Channeler" and "Hellfire Watchtower" in Hellfire Ramparts, Syndicate mobs in Old Hillsbrad Foothills, "Neg'Jin Shackler" in The Arcatraz, "Blood Elf Reclaimer" in The Mechanar) — and because the addon matches mobs by name, every one of those entries was dead weight while the real trash fell back to generic handling. Every dungeon now lists its actual trash roster with verified spellings (including hyphenation such as "Eredar Soul-Eater" and the unhyphenated "Nexus Stalker").
- **Skull/Cross Now Follow Warrior-Tank Threat Priorities:** Danger levels were reassessed for a warrior tank in 5-mans. Critical (kill-first) status goes to healers (Hellfire Watcher, Coilfang Oracle, Murkblood Healer, Ethereal Priest, Cabal Shadow Priest, Bloodwarder Mender/Physician, Ethereum Life-Binder, Sunblade Blood Knight, Tarren Mill Protector, Durnholde Warden), summoners and reinforcement-callers (Shadowmoon Summoner, Cabal Summoner, Shattered Hand Legionnaire, Bonechewer Beastmaster, Durnholde Lookout, Shattered Hand Scout), mind-controllers (Coilfang Soothsayer, Time-Lost Controller, Phantasmal Possessor, Spiteful Temptress, Sister of Torment), and tank-ignoring or must-die mobs (Felguard Annihilator, Death Watcher, Negaton Warp-Master, Underbog Lord, Bog Overlord, Mechanar Tinkerer, Rift Keeper/Lord). High-danger status covers silencers, fear/AoE casters, mana burners and ranged mobs that will not come to the tank.
- **CC Preferences Now Match Creature Types and Group Reality:** CC-preferred mobs carry the mark of a crowd control that actually works on them — Banish (Triangle) for the demon/elemental trash of The Arcatraz, the Steamvault and Underbog elementals, Fel Overseer and the Blood Furnace Felguards; Hibernate (Circle) for Sethekk birds, Coilfang Rays and Black Morass dragonkin filler; Shackle (Star) for Auchenai Crypts undead; Sap (Diamond) for Bloodwarder melee. Known CC immunities are flagged so marks are never wasted (Bonechewer Beastmaster, Auchenai Monk, Sethekk Ravenguard, Cabal Executioner, Sunseeker Geomancer, Mutate Fear-Shrieker/Horror, Lykul Wasp/Stinger, Sunblade Sentinel, Durnholde Lookout — plus the previously verified Fen Ray and Shattered Hand Legionnaire).
- **Trivial Filler Marked SKIP:** Non-elite swarm adds and freed slaves no longer consume marks: Shattered Hand/Rabid Warhounds, Shattered Hand Zealots, Hellfire Imps, Fel Orc Neophytes, Wastewalker/Dreghood slaves (kill their handler instead — the handlers are flagged kill-first), Underbog Frenzies, Mana Leeches (death explosion), Charming Totems, Sethekk death-spirits, Protean Horrors/Spawns, Bloodfalcons, Mutate Fleshlashers, Sunblade Imps, the Wretched, Brightscale Wyrms, Infinite Whelps and Durnholde Tracking Hounds.
