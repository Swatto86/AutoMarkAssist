...
db["Halls of Stone"] = {
    ...
    ["Iron Golem Custodian"]        = { mark = 8, creatureType = "Mechanical", ccImmune = true },
...
db["Halls of Lightning"] = {
    ...
    ["Titanium Vanguard"]           = { mark = 8, creatureType = "Mechanical", ccImmune = true },
...
db["The Oculus"] = {
    ...
    ["Centrifuge Core"]             = { mark = 8, creatureType = "Elemental", ccImmune = true },
...
db["Ulduar"] = {
    ...
    ["Junk Bot"]                    = { mark = 8, creatureType = "Mechanical", ccImmune = true },
    ["Boom Bot"]                    = { mark = 8, creatureType = "Mechanical", ccImmune = true },
    ["Bomb Bot"]                    = "SKIP",
    ["Emergency Fire Bot"]          = { mark = 8, creatureType = "Mechanical", ccImmune = true },
